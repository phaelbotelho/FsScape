...
# 913 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
}
...

{
 char c;
    int i, p, w;
# 971 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    p = (0 <= prec) ? prec : 1;
    w = width;
...
# 1143 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
  ...
  c = *cp;
  switch(c) {
# 1160 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
   case 'l':
    cp++;
    ...
    break;
# 1187 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
   case 'u':
  ...
  if (*cp == 'd' || *cp == 'i') {
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1230 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     convarg.sint = (vfpf_sint_t)(*(long *)__va_arg(*(long **)ap, (long)0));
     break;
# 1254 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
   }
  ...
  if (0
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1295 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     convarg.uint = (vfpf_uint_t)(*(unsigned long *)__va_arg(*(unsigned long **)ap, (unsigned long)0));
     break;
# 1319 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
   }
